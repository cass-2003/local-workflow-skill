...
description: Prompt Engineering 与 LLM 应用优化引擎。覆盖 System Prompt 设计、Few-shot/CoT/ToT/ReAct、结构化输出、Token 优化、评估框架、多模态 Prompt。当用户提到Prompt Engineering、提示工程、System Prompt、Few-shot、Chain of Thought、CoT、Tree of Thought、ReAct时使用。
