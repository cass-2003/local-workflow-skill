...
description: 技术文档工程引擎。覆盖 API 文档、架构文档、用户指南、Changelog、ADR、Docs-as-Code、Markdown/AsciiDoc/reStructuredText。当用户提到技术文档、Technical Writing、API 文档、架构文档、用户指南、Changelog、ADR、Architecture Decision Record时使用。
