...
| [下一步工作包](planning/下一步工作包.md) | 自主推进循环的候选目标、验收标准、验证方式和上轮自审结论 | draft |
...
- `继续推进项目` / `自动审计修复`：先更新 `planning/开发路线图.md`、`planning/下一步工作包.md` 和 `state/PROGRESS.md`，再按单一工作包循环执行。
