...
### ai-automation — AI 与自动化（16）
> 来源：codex 10、cskills 6
- **codex**：ai-agent-dev、ai-orchestrator、mlops、playwright、playwright-e2e、playwright-interactive、prompt-engineering、rag-engineering、speech、transcribe
- **cskills**：agent-briefing、ai-engineering、ai-image-prompt、autojs-automation、llm-eval、mcp-tool-use

### backend-api — 后端与 API（23）
> 来源：ours 4、codex 15、cskills 4
- **ours**：background-jobs、dockerfile-best、echo-go-server、websocket-impl
- **codex**：api-design、api-discovery、aspnet-core、cms-headless、django-dev、event-driven、fastapi-dev、graphql-dev、laravel-dev、microservices、nestjs-dev、rails-dev、realtime-communication、service-mesh、spring-boot-dev
...
### content-authoring — 内容创作与文档（12）
> 来源：codex 10、cskills 2
- **codex**：doc-office、jupyter-notebook、notion-knowledge-capture、notion-meeting-intelligence、notion-research-documentation、notion-spec-to-implementation、pdf、quick-translate、research-paper-writing、technical-writing
- **cskills**：document-authoring、presentation-authoring

### data-analysis — 数据与分析（8）
> 来源：ours 3、codex 4、cskills 1
- **ours**：sync-bidirectional、validation-pipeline、validation-schema
- **codex**：data-engineering、data-visualization、database、sql-optimization
- **cskills**：spreadsheet-analysis

### engineering-core — 通用工程模式（23）
> 来源：ours 19、codex 3、cskills 1
...
- **codex**：domains、shell-scripting、system-design
- **cskills**：ponytail

### frontend-ui — 前端与 UI（33）
> 来源：ours 7、codex 22、cskills 4
- **ours**：anti-detection、chrome-mv3-ext、css-modern-2025、dom-scraping、i18n-trio、panel-ui、preact-popup
- **codex**：UIdesign、accessibility、angular-dev、chatgpt-apps、figma、figma-code-connect-components、figma-create-design-system-rules、figma-create-new-file、figma-generate-design、figma-generate-library、figma-implement-design、figma-use、floatly-design-implementation、floatly-ui-style、frontend-dev、graphics-rendering、i18n-l10n、nextjs-dev、screenshot、svelte-dev、vue-dev、winui-app
...
### mobile-crossplatform — 移动与跨端（15）
> 来源：codex 4、cskills 11
- **codex**：flutter-dart-dev、kotlin-android-dev、react-native-dev、swift-ios-dev
...
### product-growth — 产品与增长（7）
> 来源：codex 2、cskills 5
- **codex**：linear、sentry
- **cskills**：ai-content-marketing、product-manager、product-marketing、project-promo-writer、social-media-ops

### programming-languages — 编程语言（18）
> 来源：codex 9、cskills 9
- **codex**：c-cpp-dev、csharp-dotnet-dev、go-dev、java-dev、js-ts-dev、php-dev、python-dev、ruby-dev、rust-dev
...
### quality-delivery — 质量与交付（21）
> 来源：codex 16、cskills 5
- **codex**：cli-creator、code-audit、code-migration、code-simplifier、commit、devex-tooling、gh-address-comments、gh-fix-ci、git-workflow、low-code、performance-testing、qa、refactor、testing、tools、yeet
...
### reverse-engineering — 逆向工程（62）
> 来源：codex 5、cskills 57
- **codex**：android-reversing、binary-exploit、dotnet-reversing、reverse-analysis、reverse-engineering
...
- **codex**：attack-chain-orchestrator、audit、autoredteam-orchestrator、deep-thinking、dev、fix、implement、mcp-builder、memory、migrate-to-codex、orchestration、review、skill-creator、spec、spec-check、spec-do、sprint、status、sync-docs

## 分级与变体（框架路线图阶段 6）

- ✅ 已打"通用 / 半通用 / 项目定制"标记：**通用 323 · 半通用 49 · 项目定制 26**，详见 `TIERS.md`。
- ✅ 已移除全部 `anna-*` 与 `coff0xc-*` 家族（36 个），近义变体大幅收敛。
