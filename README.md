...
![skills](https://img.shields.io/badge/skills-557-2ea44f)
...
└───────────────────────────┬─────────────────────────────────┘
                            │ Phase 4/5 委托 ↓
┌───────────────────────────▼─────────────────────────────────┐
│  🛠️ skills/   557 技能 / 58 领域大类（双层 <大类>/<来源>/）      │
...
技能按通用性分级：**🟢 通用 474 · 🟡 半通用 83 · 🔵 项目定制 0**（见 [`skills/TIERS.md`](skills/TIERS.md)）。完整索引见 [`skills/README.md`](skills/README.md)。
